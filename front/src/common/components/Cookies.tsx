    ...
    return (
        <>
            {(!hasUserAcceptedCookies() || !showCookiesConsent) ?
                <div className="cookie-consent border-top p-4"><span>Serwis <a href="https://lokalsi.cc">lokalsi.cc</a> wykorzystuje pliki cookies. Korzystając ze strony wyrażasz zgodę na ich użycie.
